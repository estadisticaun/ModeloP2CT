...
background-image: url("https://github.com/estadisticaun/ModeloP2CT/blob/main/imagenes/De_La_Paz.jpg")
...
# (P) <br> Planeación <br> `r emo::ji("teacher")`

---
class: center, middle

# (C) <br> Conceptualización <br> `r emo::ji("teacher")`

---
class: center, middle

# (P) <br> Producción <br> `r emo::ji("teacher")`

---
class: center, middle

# (T) <br> Tecnología <br> `r emo::ji("teacher")`

---
class: center, middle

# (C) <br> Cultura Estadística <br> `r emo::ji("teacher")`
